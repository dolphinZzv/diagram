...
import { Bold, Italic, RotateCw, Trash2, X } from "lucide-react";
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <SliderRow
          ...
          max={12}
          step={0.5}
          onChange={(v) => update(id, { strokeWidth: v })}
        />
        ...
        <SliderRow
          ...
          min={8}
          max={48}
          onChange={(v) => update(id, { fontSize: v })}
        />
        ...
        <SliderRow
          ...
          max={180}
          suffix="°"
          onChange={(v) => update(id, { rotation: v })}
        />
        ...
        <SliderRow
          ...
          max={1}
          step={0.05}
          onChange={(v) => update(id, { opacity: v })}
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        <Row label="箭头样式">
          <Select value={data.arrowType} onValueChange={(v) => update(id, { arrowType: v as EdgeData["arrowType"] })}>
            <SelectTrigger className="h-8 text-xs">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <SliderRow
          label="标签角度"
          value={data.labelRotation}
          min={-180}
          max={180}
          suffix="°"
          onChange={(v) => update(id, { labelRotation: v })}
        />
